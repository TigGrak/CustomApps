...
>作者衷心希望你能够将自己设计的节日图标、文字颜色或是修改过后的 `jinfo.json` 发送到 `tiggrak@163.com` 作者会将部分自定义API节日的图标和文字颜色上传至云端供大家使用。同时，你将会进入本markdown的感谢名单内。感谢你为此项目的付出！
...
> **_如直接复制请删除注释！！!_<br />_如直接复制请删除注释！！!_<br />_如直接复制请删除注释！！!_**

<br />

> **_文件格式、语法错误可能会导致程序崩溃（删除注释），请注意！！!_**
